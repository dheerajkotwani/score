...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private void displayA(int number) {
        TextView srcA = (TextView) findViewById(R.id.TeamAScore);
        srcA.setText("" + number);}

    private void displayB(int number) {
        TextView srcB = (TextView) findViewById(R.id.TeamBScore);
        srcB.setText("" + number);}

        private void display(String win){
            TextView winner = (TextView) findViewById(R.id.winnerr);
            winner.setText(win);
        }
